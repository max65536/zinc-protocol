...
export interface TestBridgeInterface extends utils.Interface {
    functions: {
        ...
        "testEvmChainId()": FunctionFragment;
        "testTruncate(bytes32)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "excludeArtifacts" | "excludeContracts" | "excludeSenders" | "failed" | "setUp" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetSelectors" | "targetSenders" | "testEvmChainId" | "testTruncate"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "testEvmChainId", values?: undefined): string;
    encodeFunctionData(functionFragment: "testTruncate", values: [PromiseOrValue<BytesLike>]): string;
    ...
    decodeFunctionResult(functionFragment: "testEvmChainId", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testTruncate", data: BytesLike): Result;
    events: {
...
export interface TestBridge extends BaseContract {
    ...
    functions: {
        ...
        testEvmChainId(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testTruncate(b: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    IS_TEST(overrides?: CallOverrides): Promise<boolean>;
    ...
    callStatic: {
        ...
        targetSelectors(overrides?: CallOverrides): Promise<StdInvariant.FuzzSelectorStructOutput[]>;
        targetSenders(overrides?: CallOverrides): Promise<string[]>;
        testEvmChainId(overrides?: CallOverrides): Promise<void>;
        testTruncate(b: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
