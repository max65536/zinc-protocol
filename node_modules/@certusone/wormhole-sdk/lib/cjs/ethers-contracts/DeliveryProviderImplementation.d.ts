...
export interface DeliveryProviderImplementationInterface extends utils.Interface {
    functions: {
...
export interface DeliveryProviderImplementation extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DeliveryProviderImplementationInterface;
