...
export interface TestSetupInterface extends utils.Interface {
    functions: {
        ...
        "testInitialize_after_setup_revert(bytes32,address)": FunctionFragment;
        "testInitialize_after_setup_revert_KEVM(bytes32,address)": FunctionFragment;
        "testSetup_after_setup_revert(bytes32,address,address,address,uint16,uint16,bytes32,uint256)": FunctionFragment;
        "testSetup_after_setup_revert_KEVM(bytes32,address,address,address,uint16,uint16,bytes32,uint256)": FunctionFragment;
        "validSignature(uint256,bytes32)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "arrayElementLocation" | "excludeArtifacts" | "excludeContracts" | "excludeSenders" | "failed" | "hashedLocation(bytes32,bytes32)" | "hashedLocation(address,bytes32)" | "hashedLocationOffset" | "kevm" | "setUp" | "storeWithMask" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetSelectors" | "targetSenders" | "testInitialize_after_setup_revert" | "testInitialize_after_setup_revert_KEVM" | "testSetup_after_setup_revert" | "testSetup_after_setup_revert_KEVM" | "validSignature"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "testInitialize_after_setup_revert", values: [PromiseOrValue<BytesLike>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "testInitialize_after_setup_revert_KEVM", values: [PromiseOrValue<BytesLike>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "testSetup_after_setup_revert", values: [
        PromiseOrValue<BytesLike>,
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<string>,
    ...
    encodeFunctionData(functionFragment: "testSetup_after_setup_revert_KEVM", values: [
        PromiseOrValue<BytesLike>,
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<string>,
    ...
    decodeFunctionResult(functionFragment: "testInitialize_after_setup_revert", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testInitialize_after_setup_revert_KEVM", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testSetup_after_setup_revert", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testSetup_after_setup_revert_KEVM", data: BytesLike): Result;
...
export interface TestSetup extends BaseContract {
    ...
    functions: {
        ...
        testInitialize_after_setup_revert(storageSlot: PromiseOrValue<BytesLike>, alice: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testInitialize_after_setup_revert_KEVM(storageSlot: PromiseOrValue<BytesLike>, alice: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testSetup_after_setup_revert(storageSlot: PromiseOrValue<BytesLike>, alice: PromiseOrValue<string>, implementation: PromiseOrValue<string>, initialGuardian: PromiseOrValue<string>, chainId: PromiseOrValue<BigNumberish>, governanceChainId: PromiseOrValue<BigNumberish>, govContract: PromiseOrValue<BytesLike>, evmChainId: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testSetup_after_setup_revert_KEVM(storageSlot: PromiseOrValue<BytesLike>, alice: PromiseOrValue<string>, implementation: PromiseOrValue<string>, initialGuardian: PromiseOrValue<string>, chainId: PromiseOrValue<BigNumberish>, governanceChainId: PromiseOrValue<BigNumberish>, govContract: PromiseOrValue<BytesLike>, evmChainId: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        targetSelectors(overrides?: CallOverrides): Promise<StdInvariant.FuzzSelectorStructOutput[]>;
        targetSenders(overrides?: CallOverrides): Promise<string[]>;
        testInitialize_after_setup_revert(storageSlot: PromiseOrValue<BytesLike>, alice: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        testInitialize_after_setup_revert_KEVM(storageSlot: PromiseOrValue<BytesLike>, alice: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        testSetup_after_setup_revert(storageSlot: PromiseOrValue<BytesLike>, alice: PromiseOrValue<string>, implementation: PromiseOrValue<string>, initialGuardian: PromiseOrValue<string>, chainId: PromiseOrValue<BigNumberish>, governanceChainId: PromiseOrValue<BigNumberish>, govContract: PromiseOrValue<BytesLike>, evmChainId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        testSetup_after_setup_revert_KEVM(storageSlot: PromiseOrValue<BytesLike>, alice: PromiseOrValue<string>, implementation: PromiseOrValue<string>, initialGuardian: PromiseOrValue<string>, chainId: PromiseOrValue<BigNumberish>, governanceChainId: PromiseOrValue<BigNumberish>, govContract: PromiseOrValue<BytesLike>, evmChainId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        validSignature(pk: PromiseOrValue<BigNumberish>, hash: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
    };
    filters: {
