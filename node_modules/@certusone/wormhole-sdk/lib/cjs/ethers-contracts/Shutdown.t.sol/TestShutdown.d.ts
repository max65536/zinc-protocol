...
export interface TestShutdownInterface extends utils.Interface {
    functions: {
        ...
        "testShutdownInit(address,bytes32)": FunctionFragment;
        "testShutdown_publishMessage_revert(address,bytes32,uint32,bytes,uint8)": FunctionFragment;
        "validSignature(uint256,bytes32)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "arrayElementLocation" | "excludeArtifacts" | "excludeContracts" | "excludeSenders" | "failed" | "hashedLocation(bytes32,bytes32)" | "hashedLocation(address,bytes32)" | "hashedLocationOffset" | "kevm" | "setUp" | "storeWithMask" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetSelectors" | "targetSenders" | "testShutdownInit" | "testShutdown_publishMessage_revert" | "validSignature"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "testShutdownInit", values: [PromiseOrValue<string>, PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "testShutdown_publishMessage_revert", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BytesLike>,
    ...
    decodeFunctionResult(functionFragment: "testShutdownInit", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testShutdown_publishMessage_revert", data: BytesLike): Result;
...
export interface TestShutdown extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestShutdownInterface;
    ...
    functions: {
        ...
        testShutdownInit(alice: PromiseOrValue<string>, storageSlot: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testShutdown_publishMessage_revert(alice: PromiseOrValue<string>, storageSlot: PromiseOrValue<BytesLike>, nonce: PromiseOrValue<BigNumberish>, payload: PromiseOrValue<BytesLike>, consistencyLevel: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        targetSelectors(overrides?: CallOverrides): Promise<StdInvariant.FuzzSelectorStructOutput[]>;
        targetSenders(overrides?: CallOverrides): Promise<string[]>;
        testShutdownInit(alice: PromiseOrValue<string>, storageSlot: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        testShutdown_publishMessage_revert(alice: PromiseOrValue<string>, storageSlot: PromiseOrValue<BytesLike>, nonce: PromiseOrValue<BigNumberish>, payload: PromiseOrValue<BytesLike>, consistencyLevel: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        validSignature(pk: PromiseOrValue<BigNumberish>, hash: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
    };
    filters: {
