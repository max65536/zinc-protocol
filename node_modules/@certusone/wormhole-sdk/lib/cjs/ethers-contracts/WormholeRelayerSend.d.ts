...
export interface WormholeRelayerSendInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "deliveryAttempted" | "deliveryFailureBlock" | "deliverySuccessBlock" | "forward" | "forwardPayloadToEvm" | "forwardToEvm" | "forwardVaasToEvm" | "getDefaultDeliveryProvider" | "getDefaultDeliveryProviderOnChain" | "getOriginalOrDefaultDeliveryProvider" | "getRegisteredWormholeRelayerContract" | "quoteDeliveryPrice" | "quoteEVMDeliveryPrice(uint16,uint256,uint256,address)" | "quoteEVMDeliveryPrice(uint16,uint256,uint256)" | "quoteNativeForChain" | "resend" | "resendToEvm" | "send" | "sendPayloadToEvm(uint16,address,bytes,uint256,uint256,uint16,address)" | "sendPayloadToEvm(uint16,address,bytes,uint256,uint256)" | "sendToEvm" | "sendVaasToEvm(uint16,address,bytes,uint256,uint256,(uint16,bytes32,uint64)[])" | "sendVaasToEvm(uint16,address,bytes,uint256,uint256,(uint16,bytes32,uint64)[],uint16,address)"): FunctionFragment;
...
export interface WormholeRelayerSend extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: WormholeRelayerSendInterface;
