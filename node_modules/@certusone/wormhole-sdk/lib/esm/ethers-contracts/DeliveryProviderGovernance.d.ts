...
export interface DeliveryProviderGovernanceInterface extends utils.Interface {
    functions: {
...
export interface DeliveryProviderGovernance extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DeliveryProviderGovernanceInterface;
