...
export interface DeliveryProviderProxyInterface extends utils.Interface {
    functions: {};
    events: {
...
export interface DeliveryProviderProxy extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DeliveryProviderProxyInterface;
