...
export interface TestMessagesInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "excludeArtifacts" | "excludeContracts" | "excludeSenders" | "failed" | "setUp" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetSelectors" | "targetSenders" | "testCannotVerifySignaturesWithInvalidSignature" | "testCannotVerifySignaturesWithOutOfBoundsSignature" | "testHashMismatchedVMIsNotVerified" | "testQuorum" | "testQuorumCanAlwaysBeReached" | "testVerifySignatures"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "testCannotVerifySignaturesWithInvalidSignature", values: [PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "testCannotVerifySignaturesWithOutOfBoundsSignature", values: [PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "testHashMismatchedVMIsNotVerified", values?: undefined): string;
    encodeFunctionData(functionFragment: "testQuorum", values?: undefined): string;
    encodeFunctionData(functionFragment: "testQuorumCanAlwaysBeReached", values: [PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "testVerifySignatures", values: [PromiseOrValue<BytesLike>]): string;
    ...
    decodeFunctionResult(functionFragment: "testCannotVerifySignaturesWithInvalidSignature", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testCannotVerifySignaturesWithOutOfBoundsSignature", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testHashMismatchedVMIsNotVerified", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testQuorum", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testQuorumCanAlwaysBeReached", data: BytesLike): Result;
...
export interface TestMessages extends BaseContract {
    ...
    functions: {
        ...
        testCannotVerifySignaturesWithInvalidSignature(encoded: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testCannotVerifySignaturesWithOutOfBoundsSignature(encoded: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testHashMismatchedVMIsNotVerified(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testQuorum(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testQuorumCanAlwaysBeReached(numGuardians: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testVerifySignatures(encoded: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    IS_TEST(overrides?: CallOverrides): Promise<boolean>;
    ...
    callStatic: {
        ...
        targetSelectors(overrides?: CallOverrides): Promise<StdInvariant.FuzzSelectorStructOutput[]>;
        targetSenders(overrides?: CallOverrides): Promise<string[]>;
        testCannotVerifySignaturesWithInvalidSignature(encoded: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        testCannotVerifySignaturesWithOutOfBoundsSignature(encoded: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        testHashMismatchedVMIsNotVerified(overrides?: CallOverrides): Promise<void>;
        testQuorum(overrides?: CallOverrides): Promise<void>;
        testQuorumCanAlwaysBeReached(numGuardians: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        testVerifySignatures(encoded: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
