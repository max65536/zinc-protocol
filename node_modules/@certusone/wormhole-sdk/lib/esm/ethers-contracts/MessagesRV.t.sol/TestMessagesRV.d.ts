...
export declare namespace TestMessagesRV {
    type GuardianSetParamsStruct = {
        privateKeys: PromiseOrValue<BigNumberish>[];
        guardianCount: PromiseOrValue<BigNumberish>;
        expirationTime: PromiseOrValue<BigNumberish>;
    };
    type GuardianSetParamsStructOutput = [BigNumber[], number, number] & {
        privateKeys: BigNumber[];
...
export interface TestMessagesRVInterface extends utils.Interface {
    functions: {
        ...
        "testCannotVerifySignaturesWithInvalidSignature1(bytes,(uint256[],uint8,uint32),(bytes32,bytes32,uint8,uint8))": FunctionFragment;
        "testCannotVerifySignaturesWithInvalidSignature2(bytes,(uint256[],uint8,uint32),uint8,uint256)": FunctionFragment;
        "testCannotVerifySignaturesWithOutOfBoundsSignature(bytes,(uint256[],uint8,uint32),uint8,uint8)": FunctionFragment;
        "testVerifySignatures(bytes,(uint256[],uint8,uint32))": FunctionFragment;
        "validSignature(uint256,bytes32)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "arrayElementLocation" | "excludeArtifacts" | "excludeContracts" | "excludeSenders" | "failed" | "hashedLocation(bytes32,bytes32)" | "hashedLocation(address,bytes32)" | "hashedLocationOffset" | "kevm" | "setUp" | "storeWithMask" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetSelectors" | "targetSenders" | "testCannotVerifySignaturesWithInvalidSignature1" | "testCannotVerifySignaturesWithInvalidSignature2" | "testCannotVerifySignaturesWithOutOfBoundsSignature" | "testVerifySignatures" | "validSignature"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "testCannotVerifySignaturesWithInvalidSignature1", values: [
        PromiseOrValue<BytesLike>,
        TestMessagesRV.GuardianSetParamsStruct,
        Structs.SignatureStruct
    ]): string;
    encodeFunctionData(functionFragment: "testCannotVerifySignaturesWithInvalidSignature2", values: [
        PromiseOrValue<BytesLike>,
        TestMessagesRV.GuardianSetParamsStruct,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>
    ]): string;
    encodeFunctionData(functionFragment: "testCannotVerifySignaturesWithOutOfBoundsSignature", values: [
        PromiseOrValue<BytesLike>,
        TestMessagesRV.GuardianSetParamsStruct,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>
    ]): string;
    encodeFunctionData(functionFragment: "testVerifySignatures", values: [PromiseOrValue<BytesLike>, TestMessagesRV.GuardianSetParamsStruct]): string;
    ...
    decodeFunctionResult(functionFragment: "testCannotVerifySignaturesWithInvalidSignature1", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testCannotVerifySignaturesWithInvalidSignature2", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testCannotVerifySignaturesWithOutOfBoundsSignature", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testVerifySignatures", data: BytesLike): Result;
...
export interface TestMessagesRV extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestMessagesRVInterface;
    ...
    functions: {
        ...
        testCannotVerifySignaturesWithInvalidSignature1(encoded: PromiseOrValue<BytesLike>, params: TestMessagesRV.GuardianSetParamsStruct, fakeSignature: Structs.SignatureStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testCannotVerifySignaturesWithInvalidSignature2(encoded: PromiseOrValue<BytesLike>, params: TestMessagesRV.GuardianSetParamsStruct, fakeGuardianIndex: PromiseOrValue<BigNumberish>, fakeGuardianPrivateKey: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testCannotVerifySignaturesWithOutOfBoundsSignature(encoded: PromiseOrValue<BytesLike>, params: TestMessagesRV.GuardianSetParamsStruct, outOfBoundsGuardian: PromiseOrValue<BigNumberish>, outOfBoundsAmount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testVerifySignatures(encoded: PromiseOrValue<BytesLike>, params: TestMessagesRV.GuardianSetParamsStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        targetSelectors(overrides?: CallOverrides): Promise<StdInvariant.FuzzSelectorStructOutput[]>;
        targetSenders(overrides?: CallOverrides): Promise<string[]>;
        testCannotVerifySignaturesWithInvalidSignature1(encoded: PromiseOrValue<BytesLike>, params: TestMessagesRV.GuardianSetParamsStruct, fakeSignature: Structs.SignatureStruct, overrides?: CallOverrides): Promise<void>;
        testCannotVerifySignaturesWithInvalidSignature2(encoded: PromiseOrValue<BytesLike>, params: TestMessagesRV.GuardianSetParamsStruct, fakeGuardianIndex: PromiseOrValue<BigNumberish>, fakeGuardianPrivateKey: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        testCannotVerifySignaturesWithOutOfBoundsSignature(encoded: PromiseOrValue<BytesLike>, params: TestMessagesRV.GuardianSetParamsStruct, outOfBoundsGuardian: PromiseOrValue<BigNumberish>, outOfBoundsAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        testVerifySignatures(encoded: PromiseOrValue<BytesLike>, params: TestMessagesRV.GuardianSetParamsStruct, overrides?: CallOverrides): Promise<void>;
        validSignature(pk: PromiseOrValue<BigNumberish>, hash: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
    };
    filters: {
