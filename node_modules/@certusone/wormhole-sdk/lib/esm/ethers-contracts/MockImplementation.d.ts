...
export interface MockImplementationInterface extends utils.Interface {
    functions: {
...
export interface MockImplementation extends BaseContract {
    ...
    functions: {
        ...
        getGuardianSet(index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[Structs.GuardianSetStructOutput]>;
        ...
        parseContractUpgrade(encodedUpgrade: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[
            GovernanceStructs.ContractUpgradeStructOutput
        ] & {
            cu: GovernanceStructs.ContractUpgradeStructOutput;
        }>;
        parseGuardianSetUpgrade(encodedUpgrade: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[
        ...
        parseSetMessageFee(encodedSetMessageFee: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[
            GovernanceStructs.SetMessageFeeStructOutput
        ] & {
            smf: GovernanceStructs.SetMessageFeeStructOutput;
        }>;
        parseTransferFees(encodedTransferFees: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[
            GovernanceStructs.TransferFeesStructOutput
        ] & {
            tf: GovernanceStructs.TransferFeesStructOutput;
        }>;
        parseVM(encodedVM: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[Structs.VMStructOutput] & {
            vm: Structs.VMStructOutput;
        }>;
        ...
        quorum(numGuardians: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber] & {
            numSignaturesRequiredForQuorum: BigNumber;
        }>;
        submitContractUpgrade(_vm: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        submitNewGuardianSet(_vm: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        submitRecoverChainId(_vm: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        submitSetMessageFee(_vm: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        submitTransferFees(_vm: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        verifySignatures(hash: PromiseOrValue<BytesLike>, signatures: Structs.SignatureStruct[], guardianSet: Structs.GuardianSetStruct, overrides?: CallOverrides): Promise<[boolean, string] & {
            valid: boolean;
            reason: string;
        }>;
        verifyVM(vm: Structs.VMStruct, overrides?: CallOverrides): Promise<[boolean, string] & {
            valid: boolean;
            reason: string;
        }>;
    };
    ...
    parseContractUpgrade(encodedUpgrade: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<GovernanceStructs.ContractUpgradeStructOutput>;
    parseGuardianSetUpgrade(encodedUpgrade: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<GovernanceStructs.GuardianSetUpgradeStructOutput>;
    parseRecoverChainId(encodedRecoverChainId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<GovernanceStructs.RecoverChainIdStructOutput>;
    parseSetMessageFee(encodedSetMessageFee: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<GovernanceStructs.SetMessageFeeStructOutput>;
    parseTransferFees(encodedTransferFees: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<GovernanceStructs.TransferFeesStructOutput>;
    parseVM(encodedVM: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<Structs.VMStructOutput>;
    publishMessage(nonce: PromiseOrValue<BigNumberish>, payload: PromiseOrValue<BytesLike>, consistencyLevel: PromiseOrValue<BigNumberish>, overrides?: PayableOverrides & {
        from?: PromiseOrValue<string>;
    }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        quorum(numGuardians: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        submitContractUpgrade(_vm: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        submitNewGuardianSet(_vm: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        submitRecoverChainId(_vm: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        submitSetMessageFee(_vm: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        submitTransferFees(_vm: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        testNewImplementationActive(overrides?: CallOverrides): Promise<boolean>;
    ...
    estimateGas: {
        ...
        getGuardianSet(index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        parseContractUpgrade(encodedUpgrade: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        parseGuardianSetUpgrade(encodedUpgrade: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        parseRecoverChainId(encodedRecoverChainId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        parseSetMessageFee(encodedSetMessageFee: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        parseTransferFees(encodedTransferFees: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        verifySignatures(hash: PromiseOrValue<BytesLike>, signatures: Structs.SignatureStruct[], guardianSet: Structs.GuardianSetStruct, overrides?: CallOverrides): Promise<BigNumber>;
        verifyVM(vm: Structs.VMStruct, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        getGuardianSet(index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        parseContractUpgrade(encodedUpgrade: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        parseGuardianSetUpgrade(encodedUpgrade: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        parseRecoverChainId(encodedRecoverChainId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        parseSetMessageFee(encodedSetMessageFee: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        parseTransferFees(encodedTransferFees: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        parseVM(encodedVM: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        publishMessage(nonce: PromiseOrValue<BigNumberish>, payload: PromiseOrValue<BytesLike>, consistencyLevel: PromiseOrValue<BigNumberish>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        quorum(numGuardians: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        submitContractUpgrade(_vm: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        submitNewGuardianSet(_vm: PromiseOrValue<BytesLike>, overrides?: Overrides & {
        ...
        verifySignatures(hash: PromiseOrValue<BytesLike>, signatures: Structs.SignatureStruct[], guardianSet: Structs.GuardianSetStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        verifyVM(vm: Structs.VMStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
