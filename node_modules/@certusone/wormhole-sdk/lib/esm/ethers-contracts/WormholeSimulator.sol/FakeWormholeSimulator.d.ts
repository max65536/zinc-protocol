...
export interface FakeWormholeSimulatorInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "encodeAndSignMessage" | "encodeObservation" | "fetchSignedMessageFromLogs" | "fetchWormholeMessageFromLog" | "invalidateVM" | "parseVMFromLogs" | "setMessageFee" | "wormhole"): FunctionFragment;
...
export interface FakeWormholeSimulator extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: FakeWormholeSimulatorInterface;
