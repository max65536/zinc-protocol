...
export interface SigningWormholeSimulatorInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "encodeAndSignMessage" | "encodeObservation" | "fetchSignedMessageFromLogs" | "fetchWormholeMessageFromLog" | "invalidateVM" | "parseVMFromLogs" | "setMessageFee" | "vm" | "wormhole"): FunctionFragment;
...
export interface SigningWormholeSimulator extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SigningWormholeSimulatorInterface;
    ...
    filters: {};
    estimateGas: {
        encodeAndSignMessage(vm_: IWormhole.VMStruct, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        invalidateVM(message: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        encodeAndSignMessage(vm_: IWormhole.VMStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        invalidateVM(message: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
