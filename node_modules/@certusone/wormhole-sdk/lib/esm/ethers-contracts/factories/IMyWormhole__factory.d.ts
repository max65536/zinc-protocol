...
import type { IMyWormhole, IMyWormholeInterface } from "../IMyWormhole";
export declare class IMyWormhole__factory {
    ...
    static createInterface(): IMyWormholeInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IMyWormhole;
}
